		...
		try {
		    ...
		    for(Map<String, Object> itm : its) {
		    	if(((String) itm.get("type")).equals("Magazine")) {
		    		catalog.addItem(new Magazine((String) itm.get("id"),(String) itm.get("title"),(String) itm.get("location"),(String) itm.get("author"), (String) itm.get("year")));
		    	} else if(((String) itm.get("type")).equals("Book")) {
		    		catalog.addItem(new Book((String) itm.get("id"),(String) itm.get("title"),(String) itm.get("location"), (String) itm.get("author"), (String) itm.get("year")));
		    	}
		    }
		} catch (Exception ex) {
