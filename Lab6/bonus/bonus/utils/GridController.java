...
public abstract class GridController {
	/**
	 * Generates the sticks for the grid.
	 * @param gameGrid
	 * @param intersections
	 * @return a set of sticks.
	 */
	...
	/**
	 * Generates the intersections for the grid.
	 * @param mainFrame
	 * @param gameGrid
	 * @param currPlayer
	...
	/**
	 * Draws the intersections to the grid.
	 * @param graphics
	 * @param gameGrid
	 * @param intersections
	 */
	...
	/**
	 * Checks whether there are any available moves left.
	 * @param sticks
	 * @return true if there are still available moves, otherwise false.
	 */
