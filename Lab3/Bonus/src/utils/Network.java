...
public class Network {
	...
	public void printNetwork() {
		Map<Node, Pair<Integer, Double>> list = null;
		
		for(Node n : nodes) {
			list = n.getNeighbors();
			for(Map.Entry<Node, Pair<Integer, Double>> neighbor : list.entrySet()){
				System.out.println("[ " + n.getName() + " ] -- [ " + neighbor.getKey().getName() + " ] (cost=" + neighbor.getValue().first()+") ");
			}
		}
	}
